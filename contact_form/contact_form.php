...
// configure
$from = 'hello@gergipeter.hu'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'gergipeter@gmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6LfaOS4jAAAAAIfIe7m-DPjv6QFPhc4_2FwI0O6O';
